...
var ProductsModel = /** @class */ (function () {
    ...
    ProductsModel.prototype.get = function () {
    ...
    ProductsModel.prototype.create = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var product_name, price, connection, sql, rows, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, connection.query(sql, [product_name, price])];
                    case 3:
                        rows = (_a.sent()).rows;
                        connection.release();
    ...
    ProductsModel.prototype.getById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
