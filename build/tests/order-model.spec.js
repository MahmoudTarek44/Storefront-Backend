...
describe("Order Model testing", function () {
    var order, user_id, product_id, order_id;
    ...
    function createOrder(order) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, orderModel.create(order)];
            });
        });
    }
    it("create new order query", function () {
        expect(orderModel.create).toBeDefined();
    });
    // testing queries behaviour
    it("successful create new order", function () { return __awaiter(void 0, void 0, void 0, function () {
        var createdOrder;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createOrder(order)];
                case 1:
